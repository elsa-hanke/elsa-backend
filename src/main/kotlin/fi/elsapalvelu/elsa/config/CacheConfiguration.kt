...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            ...
            createCache(cm, fi.elsapalvelu.elsa.domain.OsaamisenArviointi::class.java.name)
            createCache(cm, fi.elsapalvelu.elsa.domain.OsaamisenArviointi::class.java.name + ".osaamisalueenArviointis")
            createCache(cm, fi.elsapalvelu.elsa.domain.OsaamisalueenArviointi::class.java.name)
            createCache(cm, fi.elsapalvelu.elsa.domain.OsaamisalueenArviointi::class.java.name + ".arviointiosaalues")
            createCache(cm, fi.elsapalvelu.elsa.domain.Arviointiosaalue::class.java.name)
