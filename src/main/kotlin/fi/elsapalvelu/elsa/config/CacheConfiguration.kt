...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        ...
        return JCacheManagerCustomizer { cm ->
            ...
            createCache(cm, fi.elsapalvelu.elsa.domain.ErikoistuvaLaakari::class.java.name + ".opiskeluoikeudet")
            ...
            createCache(cm, fi.elsapalvelu.elsa.domain.Kayttaja::class.java.name + ".erikoisalat")
            ...
            createCache(cm, fi.elsapalvelu.elsa.domain.Opiskeluoikeus::class.java.name)
