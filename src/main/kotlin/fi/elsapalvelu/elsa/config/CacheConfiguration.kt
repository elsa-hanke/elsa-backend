...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        ...
        return JCacheManagerCustomizer { cm ->
            ...
            createCache(cm, fi.elsapalvelu.elsa.domain.Arviointityokalu::class.java.name + ".kysymykset")
            createCache(cm, fi.elsapalvelu.elsa.domain.ArviointityokaluKategoria::class.java.name)
            createCache(cm, fi.elsapalvelu.elsa.domain.ArviointityokaluKysymys::class.java.name)
            createCache(cm, fi.elsapalvelu.elsa.domain.ArviointityokaluKysymys::class.java.name + ".vaihtoehdot")
            createCache(cm, fi.elsapalvelu.elsa.domain.ArviointityokaluKysymysVaihtoehto::class.java.name)
