...
@Entity
@Table(name = "arkistointi_job_asiakirja")
data class ArkistointiJobAsiakirja(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is ArkistointiJobAsiakirja) return false
    ...
    override fun toString() = "ArkistointiJobAsiakirja{" +
        "id=$id" +
