...
data class KoejaksonKoulutussopimus(
    ...
    @OneToMany(mappedBy = "koulutussopimus")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (koejakso != other.koejakso) return false

        return true
    }

    override fun toString(): String {
        return "KoejaksonKoulutussopimus(id=$id, erikoistuvanNimi=$erikoistuvanNimi, erikoistuvanOpiskelijatunnus=$erikoistuvanOpiskelijatunnus, erikoistuvanSyntymaaika=$erikoistuvanSyntymaaika, erikoistuvanYliopisto=$erikoistuvanYliopisto, opintooikeudenMyontamispaiva=$opintooikeudenMyontamispaiva, koejaksonAlkamispaiva=$koejaksonAlkamispaiva, erikoistuvanPuhelinnumero=$erikoistuvanPuhelinnumero, erikoistuvanSahkoposti=$erikoistuvanSahkoposti, lahetetty=$lahetetty, muokkauspaiva=$muokkauspaiva, vastuuhenkilo=$vastuuhenkilo, vastuuhenkilonNimi=$vastuuhenkilonNimi, vastuuhenkilonNimike=$vastuuhenkilonNimike, vastuuhenkiloHyvaksnyt=$vastuuhenkiloHyvaksynyt, vastuuhenkilonKuittausaika=$vastuuhenkilonKuittausaika, korjausehdotus=$korjausehdotus, koulutussopimuksenKouluttajat=$kouluttajat, koulutussopimuksenKoulutuspaikat=$koulutuspaikat)"
    }
