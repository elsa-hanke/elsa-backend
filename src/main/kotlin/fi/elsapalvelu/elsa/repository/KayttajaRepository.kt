...
interface KayttajaRepository : JpaRepository<Kayttaja, Long>, JpaSpecificationExecutor<Kayttaja> {
    ...
    @Query("select k from Kayttaja k join k.user u left join fetch k.yliopistot left join fetch k.yliopistotAndErikoisalat ye" +
        " left join fetch ye.vastuuhenkilonTehtavat where u.id = :id")
