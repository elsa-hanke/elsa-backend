...
class ArvioitavanKokonaisuudenKategoriaServiceImpl(
    ...
    override fun save(arvioitavanKokonaisuudenKategoriaDTO: ArvioitavanKokonaisuudenKategoriaDTO): ArvioitavanKokonaisuudenKategoriaDTO {
    ...
    @Transactional(readOnly = true)
    override fun findOne(id: Long): Optional<ArvioitavanKokonaisuudenKategoriaDTO> {
