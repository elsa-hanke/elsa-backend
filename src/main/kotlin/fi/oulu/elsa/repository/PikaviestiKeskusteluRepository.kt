...
interface PikaviestiKeskusteluRepository : JpaRepository<PikaviestiKeskustelu, Long> {
    ...
    @Query(
        value = "select distinct pikaviestiKeskustelu from PikaviestiKeskustelu pikaviestiKeskustelu left join fetch pikaviestiKeskustelu.keskustelijas",
    ...
    @Query("select distinct pikaviestiKeskustelu from PikaviestiKeskustelu pikaviestiKeskustelu left join fetch pikaviestiKeskustelu.keskustelijas")
    fun findAllWithEagerRelationships(): MutableList<PikaviestiKeskustelu>

    @Query("select pikaviestiKeskustelu from PikaviestiKeskustelu pikaviestiKeskustelu left join fetch pikaviestiKeskustelu.keskustelijas where pikaviestiKeskustelu.id =:id")
