...
object SeurantajaksoHelper {
    ...
    private val UPDATED_SEURAAVA_AJANKOHTA =
        LocalDate.now(ZoneId.systemDefault())

    private val DEFAULT_ALKAMISPAIVA =
        LocalDate.ofEpochDay(0L)

    private val DEFAULT_PAATTYMISPAIVA =
        DEFAULT_ALKAMISPAIVA.plusDays(10)
