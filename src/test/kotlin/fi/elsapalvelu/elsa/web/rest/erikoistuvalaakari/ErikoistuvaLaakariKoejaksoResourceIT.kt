...
class ErikoistuvaLaakariKoejaksoResourceIT {
    ...
    fun getKoejaksonVaiheet() {
        ...
        restKoejaksoMockMvc.perform(get("/api/erikoistuva-laakari/koejakso")).andExpect(status().isOk).andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.koulutussopimus").value(IsNull.notNullValue())).andExpect(jsonPath("$.aloituskeskustelu").value(IsNull.notNullValue()))
            .andExpect(jsonPath("$.valiarviointi").value(IsNull.notNullValue())).andExpect(jsonPath("$.kehittamistoimenpiteet").value(IsNull.notNullValue()))
            .andExpect(jsonPath("$.loppukeskustelu").value(IsNull.notNullValue())).andExpect(jsonPath("$.vastuuhenkilonArvio").value(IsNull.notNullValue()))
    ...
    fun getNullKoejaksonVaiheetForAnotherOpintooikeus() {
        ...
        restKoejaksoMockMvc.perform(get("/api/erikoistuva-laakari/koejakso")).andExpect(status().isOk).andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.koulutussopimus").value(IsNull.nullValue())).andExpect(jsonPath("$.aloituskeskustelu").value(IsNull.nullValue()))
            .andExpect(jsonPath("$.valiarviointi").value(IsNull.nullValue())).andExpect(jsonPath("$.kehittamistoimenpiteet").value(IsNull.nullValue()))
            .andExpect(jsonPath("$.loppukeskustelu").value(IsNull.nullValue())).andExpect(jsonPath("$.vastuuhenkilonArvio").value(IsNull.nullValue()))
    ...
    fun shouldReturnKoulutussopimusLomakeWithVastuuhenkiloByTehtavatyyppi() {
        ...
        restKoejaksoMockMvc.perform(get("/api/erikoistuva-laakari/koulutussopimus-lomake")).andExpect(status().isOk)
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE)).andExpect(jsonPath("$.vastuuhenkilo.id").value(vastuuhenkilo.id))
    }
    ...
    fun shouldThrowExceptionIfMultipleVastuuhenkiloWithSameYliopistoErikoisalaAndTehtavatyyppiExists() {
        ...
        restKoejaksoMockMvc.perform(get("/api/erikoistuva-laakari/koulutussopimus-lomake")).andExpect(status().is5xxServerError)
    }
    ...
    fun createKoulutussopimusWithExistingId() {
        ...
        val koejaksonKoulutussopimusDTO = koejaksonKoulutussopimusMapper.toDto(koejaksonKoulutussopimus)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/koulutussopimus").contentType(MediaType.APPLICATION_JSON)
                .content(convertObjectToJsonBytes(koejaksonKoulutussopimusDTO)).with(csrf())).andExpect(status().isBadRequest)
    ...
    fun createKoulutussopimusWithKouluttajaAck() {
        ...
        val koejaksonKoulutussopimusDTO = koejaksonKoulutussopimusMapper.toDto(koejaksonKoulutussopimus)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/koulutussopimus")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koejaksonKoulutussopimusDTO)).with(csrf())).andExpect(status().isBadRequest)
    ...
    fun createKoulutussopimus() {
        ...
        val koejaksonKoulutussopimusDTO = koejaksonKoulutussopimusMapper.toDto(koejaksonKoulutussopimus)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/koulutussopimus")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koejaksonKoulutussopimusDTO)).with(csrf())).andExpect(status().isCreated)
        ...
        assertThat(sopimus.opintooikeus?.erikoistuvaLaakari?.kayttaja?.getNimi()).isEqualTo(koejaksonKoulutussopimusDTO.erikoistuvanNimi)
        assertThat(sopimus.opintooikeus?.opiskelijatunnus).isEqualTo(koejaksonKoulutussopimusDTO.erikoistuvanOpiskelijatunnus)
        assertThat(sopimus.opintooikeus?.erikoistuvaLaakari?.syntymaaika).isEqualTo(koejaksonKoulutussopimusDTO.erikoistuvanSyntymaaika)
        assertThat(sopimus.opintooikeus?.yliopisto?.nimi.toString()).isEqualTo(koejaksonKoulutussopimusDTO.erikoistuvanYliopisto)
        assertThat(sopimus.opintooikeus?.erikoistuvaLaakari?.kayttaja?.user?.phoneNumber).isEqualTo(koejaksonKoulutussopimusDTO.erikoistuvanPuhelinnumero)
        assertThat(sopimus.opintooikeus?.erikoistuvaLaakari?.kayttaja?.user?.email).isEqualTo(koejaksonKoulutussopimusDTO.erikoistuvanSahkoposti)
        assertThat(sopimus.opintooikeus?.opintooikeudenMyontamispaiva).isEqualTo(koejaksonKoulutussopimusDTO.opintooikeudenMyontamispaiva)
    ...
    fun updateKoulutussopimus() {
        ...
        updatedKoulutussopimus.opintooikeus?.erikoistuvaLaakari?.kayttaja?.user?.phoneNumber = UPDATED_PHONE
        ...
        val updatedKouluttaja = KayttajaHelper.createUpdatedEntity(em, UPDATED_KOULUTTAJA_NIMI)
        em.persist(updatedKouluttaja)
        updatedKoulutussopimus.kouluttajat?.add(createKoulutussopimuksenKouluttaja(updatedKoulutussopimus, updatedKouluttaja))

        val koulutussopimusDTO = koejaksonKoulutussopimusMapper.toDto(updatedKoulutussopimus)

        restKoejaksoMockMvc.perform(put("/api/erikoistuva-laakari/koejakso/koulutussopimus")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koulutussopimusDTO)).with(csrf())).andExpect(status().isOk)
        ...
        assertThat(testKoulutussopimus.opintooikeus?.erikoistuvaLaakari?.kayttaja?.user?.phoneNumber).isEqualTo(UPDATED_PHONE)
        ...
        val testKouluttaja = testKoulutussopimus.kouluttajat?.filter { it.kouluttaja?.id == updatedKouluttaja.id }?.get(0)
    ...
    fun createAloituskeskusteluWithExistingId() {
        ...
        val koejaksonAloituskeskusteluDTO = koejaksonAloituskeskusteluMapper.toDto(koejaksonAloituskeskustelu)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/aloituskeskustelu").contentType(MediaType.APPLICATION_JSON)
                .content(convertObjectToJsonBytes(koejaksonAloituskeskusteluDTO)).with(csrf())).andExpect(status().isBadRequest)

        val keskustelu = koejaksonAloituskeskusteluRepository.findById(koejaksonAloituskeskustelu.id!!)
    ...
    fun createAloituskeskustelu() {
        ...
        val koejaksonAloituskeskusteluDTO = koejaksonAloituskeskusteluMapper.toDto(koejaksonAloituskeskustelu)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/aloituskeskustelu").contentType(MediaType.APPLICATION_JSON)
                .content(convertObjectToJsonBytes(koejaksonAloituskeskusteluDTO)).with(csrf())).andExpect(status().isCreated)
        ...
        assertThat(keskustelu.opintooikeus?.erikoistuvaLaakari?.kayttaja?.getNimi()).isEqualTo(koejaksonAloituskeskusteluDTO.erikoistuvanNimi)
        assertThat(keskustelu.opintooikeus?.erikoisala?.nimi).isEqualTo(koejaksonAloituskeskusteluDTO.erikoistuvanErikoisala)
        assertThat(keskustelu.opintooikeus?.opiskelijatunnus).isEqualTo(koejaksonAloituskeskusteluDTO.erikoistuvanOpiskelijatunnus)
        assertThat(keskustelu.opintooikeus?.yliopisto?.nimi.toString()).isEqualTo(koejaksonAloituskeskusteluDTO.erikoistuvanYliopisto)
        assertThat(keskustelu.opintooikeus?.erikoistuvaLaakari?.kayttaja?.user?.email).isEqualTo(koejaksonAloituskeskusteluDTO.erikoistuvanSahkoposti)
    ...
    fun updateAloituskeskustelu() {
        ...
        val updatedKouluttaja = KayttajaHelper.createUpdatedEntity(em, UPDATED_VASTUUHENKILO_NIMI)
        em.persist(updatedKouluttaja)
        ...
        restKoejaksoMockMvc.perform(put("/api/erikoistuva-laakari/koejakso/aloituskeskustelu")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(aloituskeskusteluDTO)).with(csrf())).andExpect(status().isOk)
        ...
        assertThat(testAloituskeskustelu.opintooikeus?.erikoistuvaLaakari?.kayttaja?.user?.email).isEqualTo(UPDATED_EMAIL)

        val testLahikouluttaja = kayttajaRepository.findById(testAloituskeskustelu.lahikouluttaja?.id!!)
    ...
    fun createValiarviointi() {
        ...
        val koejaksonValiarviointiDTO = koejaksonValiarviointiMapper.toDto(koejaksonValiarviointi)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/valiarviointi")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koejaksonValiarviointiDTO)).with(csrf())).andExpect(status().isCreated)
        ...
        assertThat(arviointi.opintooikeus?.erikoistuvaLaakari?.kayttaja?.getNimi()).isEqualTo(koejaksonValiarviointiDTO.erikoistuvanNimi)
        ...
        assertThat(arviointi.opintooikeus?.yliopisto?.nimi.toString()).isEqualTo(koejaksonValiarviointiDTO.erikoistuvanYliopisto)
    ...
    fun createValiarviointiWithoutAloituskeskustelu() {
        ...
        val koejaksonValiarviointiDTO = koejaksonValiarviointiMapper.toDto(koejaksonValiarviointi)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/valiarviointi")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koejaksonValiarviointiDTO)).with(csrf())).andExpect(status().isBadRequest)
    ...
    fun createKehittamistoimenpiteet() {
        ...
        val koejaksonKehittamistoimenpiteetDTO = koejaksonKehittamistoimenpiteetMapper.toDto(koejaksonKehittamistoimenpiteet)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/kehittamistoimenpiteet")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koejaksonKehittamistoimenpiteetDTO)).with(csrf())).andExpect(status().isCreated)
        ...
        assertThat(arviointi.opintooikeus?.erikoistuvaLaakari?.kayttaja?.getNimi()).isEqualTo(koejaksonKehittamistoimenpiteetDTO.erikoistuvanNimi)
        assertThat(arviointi.opintooikeus?.erikoisala?.nimi).isEqualTo(koejaksonKehittamistoimenpiteetDTO.erikoistuvanErikoisala)
        assertThat(arviointi.opintooikeus?.opiskelijatunnus).isEqualTo(koejaksonKehittamistoimenpiteetDTO.erikoistuvanOpiskelijatunnus)
        assertThat(arviointi.opintooikeus?.yliopisto?.nimi.toString()).isEqualTo(koejaksonKehittamistoimenpiteetDTO.erikoistuvanYliopisto)
    ...
    fun createKehittamistoimenpiteetWithoutValiarviointi() {
        ...
        val koejaksonKehittamistoimenpiteetDTO = koejaksonKehittamistoimenpiteetMapper.toDto(koejaksonKehittamistoimenpiteet)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/kehittamistoimenpiteet")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koejaksonKehittamistoimenpiteetDTO)).with(csrf())).andExpect(status().isBadRequest)
    ...
    fun createLoppukeskusteluWithKehittamistoimenpiteet() {
        ...
        val koejaksonLoppukeskusteluDTO = koejaksonLoppukeskusteluMapper.toDto(koejaksonLoppukeskustelu)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/loppukeskustelu")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koejaksonLoppukeskusteluDTO)).with(csrf())).andExpect(status().isCreated)
        ...
        assertThat(arviointi.opintooikeus?.erikoistuvaLaakari?.kayttaja?.getNimi()).isEqualTo(koejaksonLoppukeskusteluDTO.erikoistuvanNimi)
        assertThat(arviointi.opintooikeus?.erikoisala?.nimi).isEqualTo(koejaksonLoppukeskusteluDTO.erikoistuvanErikoisala)
        assertThat(arviointi.opintooikeus?.opiskelijatunnus).isEqualTo(koejaksonLoppukeskusteluDTO.erikoistuvanOpiskelijatunnus)
        assertThat(arviointi.opintooikeus?.yliopisto?.nimi.toString()).isEqualTo(koejaksonLoppukeskusteluDTO.erikoistuvanYliopisto)
    ...
    fun createLoppukeskusteluWithKehittamistoimenpiteetInvalid() {
        ...
        val koejaksonLoppukeskusteluDTO = koejaksonLoppukeskusteluMapper.toDto(koejaksonLoppukeskustelu)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/loppukeskustelu")
                .contentType(MediaType.APPLICATION_JSON).content(convertObjectToJsonBytes(koejaksonLoppukeskusteluDTO)).with(csrf())).andExpect(status().isBadRequest)
    ...
    fun createLoppukeskusteluWithoutKehittamistoimenpiteetInvalid() {
        ...
        val koejaksonLoppukeskusteluDTO = koejaksonLoppukeskusteluMapper.toDto(koejaksonLoppukeskustelu)
        restKoejaksoMockMvc.perform(post("/api/erikoistuva-laakari/koejakso/loppukeskustelu").contentType(MediaType.APPLICATION_JSON)
                .content(convertObjectToJsonBytes(koejaksonLoppukeskusteluDTO)).with(csrf())).andExpect(status().isBadRequest)
    ...
    fun createVastuuhenkilonArvio() {
        ...
        val koejaksonVastuuhenkilonArvioDTO = koejaksonVastuuhenkilonArvioMapper.toDto(koejaksonVastuuhenkilonArvio)
        val vastuuhenkilonArvioJson = objectMapper.writeValueAsString(koejaksonVastuuhenkilonArvioDTO)

        restKoejaksoMockMvc.perform(multipart("/api/erikoistuva-laakari/koejakso/vastuuhenkilonarvio").param("vastuuhenkilonArvioJson", vastuuhenkilonArvioJson)
                .with { it.method = "POST"; it }.with(csrf())).andExpect(status().isCreated)
        ...
        assertThat(arviointi.opintooikeus?.erikoistuvaLaakari?.kayttaja?.getNimi()).isEqualTo(koejaksonVastuuhenkilonArvioDTO.erikoistuvanNimi)
        assertThat(arviointi.opintooikeus?.erikoisala?.nimi).isEqualTo(koejaksonVastuuhenkilonArvioDTO.erikoistuvanErikoisala)
        assertThat(arviointi.opintooikeus?.opiskelijatunnus).isEqualTo(koejaksonVastuuhenkilonArvioDTO.erikoistuvanOpiskelijatunnus)
        assertThat(arviointi.opintooikeus?.yliopisto?.nimi.toString()).isEqualTo(koejaksonVastuuhenkilonArvioDTO.erikoistuvanYliopisto)
    ...
    fun shouldReturnVastuuhenkilonArvioLomakeWithVastuuhenkiloByTehtavatyyppi() {
        initKoejakso()
        createVastuuhenkilo(addTehtavatyyppiForKoejakso = false)
        restKoejaksoMockMvc.perform(get("/api/erikoistuva-laakari/vastuuhenkilonarvio-lomake"))
    ...
    fun shouldNotUpdateVastuuhenkilonArvioWithDifferentVastuuhenkilo() {
        ...
        restKoejaksoMockMvc.perform(multipart("/api/erikoistuva-laakari/koejakso/vastuuhenkilonarvio")
                .param("vastuuhenkilonArvioJson", vastuuhenkilonArvioJson).with { it.method = "POST"; it }.with(csrf())).andExpect(status().isBadRequest)
    }
    ...
    fun createVastuuhenkilonArvioWithoutLoppukeskustelu() {
        ...
        restKoejaksoMockMvc.perform(multipart("/api/erikoistuva-laakari/koejakso/vastuuhenkilonarvio")
                .file(MockMultipartFile("arviointiFiles", AsiakirjaHelper.ASIAKIRJA_PDF_NIMI, AsiakirjaHelper.ASIAKIRJA_PDF_TYYPPI, tempFile.readBytes()))
                .param("vastuuhenkilonArvioJson", vastuuhenkilonArvioJson).with { it.method = "POST"; it }.with(csrf())).andExpect(status().isBadRequest)
    ...
    private fun initKoejakso() {
        ...
        koejaksonKoulutussopimus.kouluttajat = mutableSetOf(createKoulutussopimuksenKouluttaja(koejaksonKoulutussopimus, kouluttaja))
        koejaksonKoulutussopimus.koulutuspaikat = mutableSetOf(createKoulutussopimuksenKoulutuspaikka(koejaksonKoulutussopimus, yliopisto))

        koejaksonAloituskeskustelu = createAloituskeskustelu(erikoistuvaLaakari, kouluttaja, esimies)
        koejaksonValiarviointi = createValiarviointi(erikoistuvaLaakari, kouluttaja, esimies)
        koejaksonKehittamistoimenpiteet = createKehittamistoimenpiteet(erikoistuvaLaakari, kouluttaja, esimies)
    ...
    companion object {
        ...
        @JvmStatic
        fun createKoulutussopimus(erikoistuvaLaakari: ErikoistuvaLaakari, vastuuhenkilo: Kayttaja): KoejaksonKoulutussopimus {
            return KoejaksonKoulutussopimus(opintooikeus = erikoistuvaLaakari.getOpintooikeusKaytossa(),
                koejaksonAlkamispaiva = DEFAULT_ALKAMISPAIVA, lahetetty = false, muokkauspaiva = DEFAULT_MUOKKAUSPAIVA, vastuuhenkilo = vastuuhenkilo,)
        }

        @JvmStatic
        fun createKoulutussopimuksenKouluttaja(koejaksonKoulutussopimus: KoejaksonKoulutussopimus, kouluttaja: Kayttaja): KoulutussopimuksenKouluttaja {
            return KoulutussopimuksenKouluttaja(kouluttaja = kouluttaja, koulutussopimus = koejaksonKoulutussopimus)
        }

        @JvmStatic
        fun createKoulutussopimuksenKoulutuspaikka(koejaksonKoulutussopimus: KoejaksonKoulutussopimus, yliopisto: Yliopisto): KoulutussopimuksenKoulutuspaikka {
            return KoulutussopimuksenKoulutuspaikka(nimi = DEFAULT_KOULUTUSPAIKKA, yliopisto = yliopisto, koulutussopimus = koejaksonKoulutussopimus)
        }

        @JvmStatic
        fun createAloituskeskustelu(erikoistuvaLaakari: ErikoistuvaLaakari, lahikouluttaja: Kayttaja, lahiesimies: Kayttaja): KoejaksonAloituskeskustelu {
            val opintooikeus = erikoistuvaLaakari.getOpintooikeusKaytossa()
            return KoejaksonAloituskeskustelu(opintooikeus = opintooikeus, koejaksonSuorituspaikka = DEFAULT_KOULUTUSPAIKKA, koejaksonAlkamispaiva = DEFAULT_ALKAMISPAIVA,
                koejaksonPaattymispaiva = DEFAULT_PAATTYMISPAIVA, suoritettuKokoaikatyossa = true, lahikouluttaja = lahikouluttaja, lahiesimies = lahiesimies,
                koejaksonOsaamistavoitteet = DEFAULT_OSAAMISTAVOITTEET, lahetetty = false, muokkauspaiva = DEFAULT_MUOKKAUSPAIVA)
        }

        @JvmStatic
        fun createValiarviointi(erikoistuvaLaakari: ErikoistuvaLaakari, lahikouluttaja: Kayttaja, lahiesimies: Kayttaja): KoejaksonValiarviointi {
            val opintooikeus = erikoistuvaLaakari.getOpintooikeusKaytossa()
            return KoejaksonValiarviointi(opintooikeus = opintooikeus, edistyminenTavoitteidenMukaista = false, vahvuudet = DEFAULT_VAHVUUDET,
                kehittamistoimenpiteet = DEFAULT_KEHITTAMISTOIMENPITEET, lahikouluttaja = lahikouluttaja, lahiesimies = lahiesimies, muokkauspaiva = DEFAULT_MUOKKAUSPAIVA)
        }

        @JvmStatic
        fun createKehittamistoimenpiteet(erikoistuvaLaakari: ErikoistuvaLaakari, lahikouluttaja: Kayttaja, lahiesimies: Kayttaja): KoejaksonKehittamistoimenpiteet {
            val opintooikeus = erikoistuvaLaakari.getOpintooikeusKaytossa()
            return KoejaksonKehittamistoimenpiteet(opintooikeus = opintooikeus, kehittamistoimenpiteetRiittavat = true, lahikouluttaja = lahikouluttaja,
                lahiesimies = lahiesimies, muokkauspaiva = DEFAULT_MUOKKAUSPAIVA)
        }

        @JvmStatic
        fun createLoppukeskustelu(erikoistuvaLaakari: ErikoistuvaLaakari, lahikouluttaja: Kayttaja, lahiesimies: Kayttaja): KoejaksonLoppukeskustelu {
            val opintooikeus = erikoistuvaLaakari.getOpintooikeusKaytossa()
            return KoejaksonLoppukeskustelu(opintooikeus = opintooikeus, esitetaanKoejaksonHyvaksymista = true, lahikouluttaja = lahikouluttaja,
                lahiesimies = lahiesimies, muokkauspaiva = DEFAULT_MUOKKAUSPAIVA)
        }

        @JvmStatic
        fun createVastuuhenkilonArvio(erikoistuvaLaakari: ErikoistuvaLaakari, vastuuhenkilo: Kayttaja): KoejaksonVastuuhenkilonArvio {
            return KoejaksonVastuuhenkilonArvio(opintooikeus = erikoistuvaLaakari.getOpintooikeusKaytossa(), vastuuhenkilo = vastuuhenkilo, muokkauspaiva = DEFAULT_MUOKKAUSPAIVA)
        }
    }
}
